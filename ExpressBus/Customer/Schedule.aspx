        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <asp:DropDownList ID="ddlOrigin" runat="server" class="form-control" DataSourceID="SqlDataSource1" DataTextField="stationname" DataValueField="stationname"></asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ExpressBusCS %>" SelectCommand="SELECT * FROM [Station] WHERE ([stationstatus] = @status)">
                        <SelectParameters>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <asp:DropDownList ID="ddlDestination" runat="server" class="form-control" DataSourceID="SqlDataSource1" DataTextField="stationname" DataValueField="stationname"></asp:DropDownList>
                </div>
