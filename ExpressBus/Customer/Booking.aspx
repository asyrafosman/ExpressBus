...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="table table-hover">
        ...
        <tr class="success">
            <th>
                <div style="color: black">Bus Number</div>
            </th>
            <td class="info">
                <div style="color: black">
        ...
        <tr class="success">
            <th>
                <div style="color: black">Depart Date</div>
            </th>
            <td class="info">
                <div style="color: black">
        ...
        <tr class="success">
            <th>
                <div style="color: black">Depart Time</div>
            </th>
            <td class="info">
                <div style="color: black">
        ...
        <tr class="success">
            <th>
                <div style="color: black">Arrival Time</div>
            </th>
            <td class="info">
                <div style="color: black">
        ...
        <tr class="success">
            <th>
                <div style="color: black">Contact No</div>
            </th>
            <td class="info">
                <div style="color: black">
        ...
        <tr class="success">
            <th>
                <div style="color: black">E-Mail</div>
            </th>
            <td class="info">
                <div style="color: black">
    ...
    <div class="form-group text-center" id="demo1" style="display: none;">
        ...
        <label>
            <img src='../img/cards/visa.png' /></label>
        <label>
            <img src='../img/cards/mastercard.png' /></label>
        <label>
            <img src='../img/cards/cirrus.png' /></label>
        <label>
            <img src='../img/cards/amex.png' /></label>
        <label>
